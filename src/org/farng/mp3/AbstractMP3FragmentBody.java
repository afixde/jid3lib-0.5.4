...
public abstract class AbstractMP3FragmentBody extends AbstractMP3FileItem {
	 ...
	 */
	private List<AbstractMP3Object> objectList = new ArrayList<AbstractMP3Object>(
			AbstractMP3FragmentBody.SIZE_OBJECT_LIST);
	...
	protected AbstractMP3FragmentBody(final AbstractMP3FragmentBody copyObject) {
		super(copyObject);
		final Iterator<AbstractMP3Object> iterator = (Iterator<AbstractMP3Object>) copyObject.iterator();
	 ...
	 * written to file. This is not guaranteed to be accurate 100% of the time.
	 *
	...
	/**
	 * Returns true if this instance and its entire <code>MP3Object</code> array
	 * list is a subset of the argument. This class is a subset if it is the
	 * same class as the argument.
	 *
	 * @param object
	 ...
	 * list equals the argument. This object is equal to the argument only if
