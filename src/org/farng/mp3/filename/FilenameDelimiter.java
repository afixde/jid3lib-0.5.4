...
/**
 * This class is a composite subclass which represents a delimiter within a
 * filename. Delimiters are usually punctuation such as " - "
 *
 * @author Eric Farng
...
public class FilenameDelimiter extends AbstractFilenameComposite {
	 ...
	 *
	 * @param delimiter
	 *            delimiter that splits the two halves of this composite
	 */
