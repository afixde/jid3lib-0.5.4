...
public class TagConstant {
     ...
     */
    public static final HashMap<Comparable<String>,String> id3v2_2FrameIdToString = new HashMap<Comparable<String>, String>();
    /**
     * <code>HashMap</code> translating the four letter ID into a human understandable string
     */
    public static final HashMap<Comparable<String>, String> id3v2_3FrameIdToString = new HashMap<Comparable<String>, String>();
    /**
     * <code>HashMap</code> translating the four letter ID into a human understandable string
     */
    public static final HashMap<Comparable<String>, String> id3v2_4FrameIdToString = new HashMap<Comparable<String>, String>();
    /**
     ...
     * <code>HashMap</code> translating the predefined string into the three letter ID
     */
    public static final HashMap<Comparable<String>, String> lyrics3v2FieldIdToString = new HashMap<Comparable<String>, String>();
    /**
     * <code>HashMap</code> translating the predefined string into the three letter ID
     */
     ...
     */
    public static final HashMap<Comparable<String>, String> id3v2_3ToId3v2_4 = new HashMap<Comparable<String>, String>();
    /**
     * <code>HashMap</code> translating the three letter ID3v2.2 ID to the corresponding ID3v2.3 ID
     */
    public static final HashMap<Comparable<String>, String> id3v2_2ToId3v2_3 = new HashMap<Comparable<String>, String>();
    /**
     * <code>HashMap</code> translating the three letter ID3v2.2 ID to the corresponding ID3v2.4 ID
     */
