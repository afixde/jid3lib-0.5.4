...
public class ID3v2_2 extends AbstractID3v2 {
    ...
    public ID3v2_2(final AbstractMP3Tag mp3tag) {
        if (mp3tag != null) {
            ...
            final Iterator<AbstractID3v2Frame> iterator = id3tag.getFrameIterator();
    ...
    public int getSize() {
        int size = 3 + 2 + 1 + 4;
        final Iterator<AbstractID3v2Frame> iterator = getFrameIterator();
        ID3v2_2Frame frame;
        while (iterator.hasNext()) {
    ...
    public String toString() {
        final Iterator<AbstractID3v2Frame> iterator = this.getFrameIterator();
        ID3v2_2Frame frame;
    ...
    public void write(final RandomAccessFile file) throws IOException {
        final String str;
        ID3v2_2Frame frame;
        final Iterator<AbstractID3v2Frame> iterator;
