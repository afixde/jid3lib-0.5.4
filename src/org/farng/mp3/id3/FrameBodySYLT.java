 ...
 * <br>
 * &nbsp;&nbsp; audio. It might also be used to describing events e.g. occurring
 * on a<br>
 * <p/>
 * &nbsp;&nbsp; stage or on the screen in sync with the audio. The header
 * includes a<br>
 * &nbsp;&nbsp; content descriptor, represented with as terminated text string.
 * If no<br>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $03 is movement/part name (e.g.
 * &quot;Adagio&quot;)<br>
 * <p/>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $04 is events (e.g. &quot;Don Quijote enters
 * the stage&quot;)<br>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
 ...
 * <br>
 * &nbsp;&nbsp; syllable (or whatever size of text is considered to be
 * convenient by<br>
 * &nbsp;&nbsp; the encoder) is a null terminated string followed by a time
 * stamp<br>
 * &nbsp;&nbsp; denoting where in the sound file it belongs. Each sync thus has
 * the<br>
 * &nbsp;&nbsp; following structure:
 * </p>
 * <p/>
 ...
 * xx &quot; in&quot; $00 xx xx &quot; the&quot; $00 xx xx<br>
 * <p/>
 * &nbsp;&nbsp;&nbsp;&nbsp; &quot; night&quot; $00 xx xx 0A &quot;Ex&quot; $00
 * xx xx &quot;chang&quot; $00 xx xx &quot;ing&quot; $00 xx<br>
 * &nbsp;&nbsp;&nbsp;&nbsp; xx &quot;glan&quot; $00 xx xx &quot;ces&quot; $00 xx
 * xx
 * </p>
 * <p/>
 * <p>
 ...
 * but only one<br>
 * &nbsp;&nbsp; with the same language and content descriptor.<br>
 * </p>
 *
 * @author Eric Farng
...
public class FrameBodySYLT extends AbstractID3v2FrameBody {
	...
	public FrameBodySYLT(final FrameBodySYLT copyObject) {
		...
		for (int i = 0; i < copyObject.lines.size(); i++) {
			newLine = new ObjectID3v2LyricLine(copyObject.lines.get(i));
	 ...
	 * Creates a new FrameBodySYLT object.
	 */
	public FrameBodySYLT(final byte textEncoding, final String language, final byte timeStampFormat,
			final byte contentType, final String description) {
	...
	public void addLyric(final ObjectLyrics3Line line) {
		final Iterator<ObjectLyrics3TimeStamp> iterator = line.getTimeStamp();
	...
	public Iterator<ObjectID3v2LyricLine> iterator() {
	...
	public String toString() {
		String str;
		str = getIdentifier() + " " + this.textEncoding + " " + this.language + " " + this.timeStampFormat + " "
				+ this.contentType + " " + this.description;
		for (int i = 0; i < this.lines.size(); i++) {
