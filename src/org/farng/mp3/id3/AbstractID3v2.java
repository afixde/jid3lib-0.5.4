...
public abstract class AbstractID3v2 extends AbstractID3 {
    ...
    protected AbstractID3v2() {
        super();
        frameMap = new HashMap<String, AbstractID3v2Frame>();
    }
    ...
    public Iterator<AbstractID3v2Frame> getFrameIterator() {
    ...
    public Iterator<AbstractID3v2Frame> getFrameOfType(final String identifier) {
        ...
        final Set<AbstractID3v2Frame> result = new HashSet<AbstractID3v2Frame>(frameMap.size());
        String hashSetKey;
        while (iterator.hasNext()) {
    ...
    public Iterator<AbstractID3v2Frame> iterator() {
    ...
    public Collection<AbstractID3v2Frame> values() {
