...
if x%PRJ_HOME%==x set PRJ_HOME=\Java\workspace\jid3lib-0.5.4\
...
echo java -Xms64M -Xmx256M -classpath %cp%  -Dwms.terminal=%TERMINAL% de.siemens.sd.it.lcmbase.gui.frame.LCMApplication %grp% %inst% -f %prop%  -s
java   -Xms64M -Xmx128M -classpath %cp%  fix.mp3.demo.unicode.FileConvert %*
